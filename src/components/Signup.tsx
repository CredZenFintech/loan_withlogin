...
import { Lock, ArrowRight, User, Mail, CheckCircle } from 'lucide-react';
import { signupWithOtp, verifySignupOtp } from '../services/authServices'; // Adjust path as needed
...
const Signup: React.FC<SignupProps> = ({ onSignup, onSwitchToLogin }) => {
  ...
  try {
    ...
    // Pass user data with token to parent or context
    onSignup({
      id: data.id,
      name: data.name,
      email: formData.email,
          ...
          <form onSubmit={handleDetailsSubmit} className="space-y-6">
            ...
            <div className="flex items-start space-x-3">
              <input
                ...
                className="mt-1 w-4 h-4 text-blue-600 border-gray-600 rounded focus:ring-blue-500 bg-gray-800"
                required
              />
